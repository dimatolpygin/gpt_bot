...
const SYSTEM = {
  role: 'system',
  content:
    'Ты умный и полезный AI-ассистент. Всегда отвечай на русском языке, независимo от языка запроса пользователя. ' +
    'Будь чётким, структурированным и содержательным.',
};
